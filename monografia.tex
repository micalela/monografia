...
\begin{obs}
    ...
    Si notamos $\Delta^1=[v_0,v_1]$ y tomamos $\sigma_i:\Delta^1\to X$ provenientes de la estructura de $\Delta$-complejo de $X$ entonces en esta dimensión, un elemento de $\Ker(\partial_1)$ es una suma formal $\sum k_i\sigma_i$ con $\sum k_i\sigma_i|_{[\hat{v_0},v_1]} - \sum k_i\sigma_i|_{[v_0,\hat{v_1}]}=0$. Un elemento de esta manera debe cumplir que cada vértice tiene el mismo número de aristas entrantes y salientes. Al ver $X$ como cociente de símplices, esto se traduce en la noción de que las imágenes de las $\sigma_i$ forman curvas cerradas.
