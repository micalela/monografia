...
Dada $\sigma_\alpha:\Delta^{n_\alpha}\to X$, notamos $\hat{\Delta}^{n_\alpha}$ a una cara de $\Delta^{n_\alpha}$. Consideramos $h:\Delta^{n_\alpha -1}\to\hat{\Delta}^{n_\alpha}$ el homeomorfismo canónico que manda el $\{n_\alpha -1\}$-símplice estándar a $\hat{\Delta}^{n_\alpha}$. Lo que nos dice este punto es que existe una función $\sigma_\beta:\Delta^{n_\alpha -1}\to X$ en la familia que cumple $\sigma_\beta=\sigma_\alpha\circ h$. Decimos entonces que $\sigma_\alpha |_{\hat{\Delta}^{n_\alpha}}$ es equivalente a $\sigma_\beta$\br
...
$$\partial_{n-1}\circ\partial_n(\sigma)=\sum\limits_{i=0}^n(-1)^i\bigg(\sum\limits_{j<i}^n (-1)^j\sigma|_{[v_0,\dots,\hat{v_i},\dots,\hat{v_j},\dots,v_n]} + \sum\limits_{j>i}^n (-1)^{j-1}\sigma|_{[v_0,\dots,\hat{v_i},\dots,\hat{v_j},\dots,v_n]}\bigg)$$
...
Obtuvimos una familia de homomorfismos $\partial_n$ entre grupos abelianos libres $\dx$ que cumplen $\partial_{n-1}\circ\;\partial{n}\equiv 0$. Agregando un último elemento $\partial_0:\Delta_0(X)\to 0$ que definimos trivialmente, tenemos 
...
Otra forma de describir la propiedad $\partial_{n-1}\circ\;\partial{n}\equiv 0$ es decir que $\im(\partial_{n+1})\subset\Ker(\partial_n)$, con esto vamos a definir los grupos de homología del complejo de cadenas.\br
...
Llamamos ciclos a los elementos de $\Ker(\partial_n)$ y bordes a los de $\im(\partial_{n+1})$.
